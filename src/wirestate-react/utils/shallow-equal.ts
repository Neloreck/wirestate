import type { ContainerActivation } from "@wirestate/core";
 ...
 */
export function shallowEqualActivation(left: Maybe<ContainerActivation>, right: Maybe<ContainerActivation>): boolean {
