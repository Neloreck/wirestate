...
export function getActivatedHandlerMetadata(instance: object): ReadonlyArray<string | symbol> {
  ...
  while (typeof constructor === "function" && constructor !== Object && constructor !== Function.prototype) {
    const own: Maybe<Array<string | symbol>> = ACTIVATED_HANDLER_METADATA.get(constructor as object);
  ...
  dbg.info(prefix(__filename), "Resolved OnActivated metadata:", { name: instance.constructor.name, chain, instance });
