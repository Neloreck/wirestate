import { type AbstractClass, type Class, getParentClasses } from "./utils";
...
export type InjectableClass<T = unknown> = (Class<T> | AbstractClass<T>) & {
  [injectableSymbol]: Array<Class<unknown>>;
};
...
export function getInjectableTargets<T>(target: InjectableClass<T>): Array<Class<unknown>> {
