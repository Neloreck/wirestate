...
import { getCommandHandlerMetadata } from "@/wirestate/commands/get-command-handler-metadata";
import { buildEventDispatcher } from "@/wirestate/events/build-event-dispatcher";
import type { EventBus } from "@/wirestate/events/event-bus";
import { getQueryHandlerMetadata } from "@/wirestate/queries/get-query-handler-metadata";
...
import { getActivatedHandlerMetadata } from "@/wirestate/service/get-activated-handler-metadata";
import { getDeactivationHandlerMetadata } from "@/wirestate/service/get-deactivation-handler-metadata";
