    ...
    <div className={"app"}>
      <header className={"app-header"}>
        ...
        <p className={"app-header__lead"}>
          The same dependency-injected MobX services, rendered by React
          components and a nested Lit web component from one shared container.
        </p>
      </header>
      ...
      <section id={"lit-island"} className={"panel"}>
        ...
        <p className={"panel__desc"}>
          A Lit web component rendered inside this React tree, injecting the
          same CounterService and ThemeService instances. Changes here and in
          the React controls above stay in sync.
        </p>
        <LitRoot />
      </section>
