/**
 * DevTools-page entry. Registers the Wirestate panel in the browser DevTools window. This page
 * itself has no UI — `panel.html` (the React app) is what renders inside the created panel.
 */
