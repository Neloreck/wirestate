...
State management framework for React based on InversifyJS dependency injection.
...
| Package | Description |
|---|---|
| [`@wirestate/core`](./src/wirestate-core/README.md) | DI container, services, events, commands, queries, seeds |
| [`@wirestate/react`](./src/wirestate-react/README.md) | React providers and hooks |
| [`@wirestate/react-mobx`](./src/wirestate-react-mobx/README.md) | MobX re-exports and decorator wrappers |
| [`@wirestate/react-signals`](./src/wirestate-react-signals/README.md) | Preact Signals re-exports |
