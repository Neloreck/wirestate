...
function typecheckSource(): string {
  return [
    ...
    'import { Injectable, OnActivation, OnDeactivation, OnDeprovision, OnProvision, type ProvisionId } from "@wirestate/core";',
    ...
    "",
    "// Lifecycle hooks under experimentalDecorators: the legacy overload must accept the",
    "// concrete method types consumers write, and still reject arguments a phase never delivers.",
    "@Injectable()",
    ...
    "}",
    "",
    "class RejectedLifecycleConsumer {",
    "  // @ts-expect-error - activation delivers no arguments.",
    "  @OnActivation()",
    ...
    "void LifecycleConsumer;",
    "void RejectedLifecycleConsumer;",
